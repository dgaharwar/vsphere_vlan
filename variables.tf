...
#  begin_ip = "${var.vlan_id}" == "901" ? "10.180.25.2" : "${var.vlan_id}" == "902" ? "10.180.26.2" : "${var.vlan_id}" == "903" ? "10.180.27.2" : "${var.vlan_id}" == "904" ? "10.180.28.2" : "${var.vlan_id}" == "905" ? "10.180.29.2" : "${var.vlan_id}" == "906" ? "10.180.30.2" :  "${var.vlan_id}" == "907" ? "10.180.31.2" : "${var.vlan_id}" == "908" ? "10.180.32.2" : "${var.vlan_id}" == "909" ? "10.180.33.2" : "${var.vlan_id}" == "910" ? "10.180.34.2" : "${var.vlan_id}" == "911" ? "10.180.35.2" : "${var.vlan_id}" == "912" ? "10.180.36.2" : "null"
#  end_ip = "${var.vlan_id}" == "901" ? "10.180.25.254" : "${var.vlan_id}" == "902" ? "10.180.26.254" : "${var.vlan_id}" == "903" ? "10.180.27.254" : "${var.vlan_id}" == "904" ? "10.180.28.254" : "${var.vlan_id}" == "905" ? "10.180.29.254" : "${var.vlan_id}" == "906" ? "10.180.30.254" :  "${var.vlan_id}" == "907" ? "10.180.31.254" : "${var.vlan_id}" == "908" ? "10.180.32.254" : "${var.vlan_id}" == "909" ? "10.180.33.254" : "${var.vlan_id}" == "910" ? "10.180.34.254" : "${var.vlan_id}" == "911" ? "10.180.35.254" : "${var.vlan_id}" == "912" ? "10.180.36.254" : "null"
